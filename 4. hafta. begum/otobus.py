...
pose = mp_pose.Pose(static_image_mode=True)  # video için false de olur
mp_draw = mp.solutions.drawing_utils

model = YOLO("yolov8n.pt")  # İnsan tespiti için

cap = cv2.VideoCapture("D:/sistem/Videolar/subway.mp4")
...
while True:
    ...
    for box in results.boxes:
        ...
        if model.names[cls_id] == 'person':
            ...
            if res.pose_landmarks:
                ...
                # Kalça, diz ve ayak bileği koordinatlarını normalize edilmiş al
    ...
    cv2.imshow("Otobüs Kişi Tespiti ve Poz Analizi", frame)
